                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">3</td><td className="py-2 px-2">Mar 6, 2026</td><td className="py-2 px-2">MC & TD Learning; Model-free Control</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture2.pdf" filename="lecture2.pdf" password="rl">Slides</ProtectedDownload> / <ProtectedDownload href="/lectures/lecture2_annotated.pdf" filename="lecture2_annotated.pdf" password="rl">Annotated</ProtectedDownload> / <ProtectedDownload href="/lectures/td_value_propagation_demo.html" filename="td_value_propagation_demo.html" password="rl">TD Demo</ProtectedDownload></td></tr>
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">8</td><td className="py-2 px-2">Apr 10, 2026</td><td className="py-2 px-2"></td><td className="py-2 px-2"></td></tr>
