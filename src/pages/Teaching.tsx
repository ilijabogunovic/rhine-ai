                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">9</td><td className="py-2 px-2">Apr 17, 2026</td><td className="py-2 px-2">Preference Learning</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture7.pdf" filename="lecture7.pdf" password="rl">Slides</ProtectedDownload></td></tr>
