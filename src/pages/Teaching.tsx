                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">5</td><td className="py-2 px-2">Mar 20, 2026</td><td className="py-2 px-2">Policy Gradients & Actor-Critic</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture4.pdf" filename="lecture4.pdf" password="rl">Slides</ProtectedDownload></td></tr>
