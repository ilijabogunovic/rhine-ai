                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr><td className="py-2 px-2">15</td><td className="py-2 px-2">May 29, 2026</td><td className="py-2 px-2">GRPO for Verifiable Reasoning</td><td className="py-2 px-2"><ProtectedDownload href="/exercises/Exercise9.ipynb" filename="Exercise9.ipynb" password="rl">Exercise 9</ProtectedDownload></td></tr>
                    </tbody>
                  </table>
                </div>
              </CardContent>
