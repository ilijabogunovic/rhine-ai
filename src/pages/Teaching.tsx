                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">12</td><td className="py-2 px-2">May 8, 2026</td><td className="py-2 px-2">Post-training LLMs: SFT, PPO & DPO</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture8.pdf" filename="lecture8.pdf" password="rl">Slides</ProtectedDownload></td></tr>
