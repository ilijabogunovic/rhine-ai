                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">6</td><td className="py-2 px-2">Mar 27, 2026</td><td className="py-2 px-2">PPO, TRPO & Modern Policy Optimization</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture5.pdf" filename="lecture5.pdf" password="rl">Slides</ProtectedDownload> / <ProtectedDownload href="/lectures/trpo_to_npg.pdf" filename="trpo_to_npg.pdf" password="rl">Note 1</ProtectedDownload> / <ProtectedDownload href="/lectures/ppo_surrogate.pdf" filename="ppo_surrogate.pdf" password="rl">Note 2</ProtectedDownload></td></tr>
                      ...
                      <tr className="border-b border-border/50"><td className="py-2 px-2">8</td><td className="py-2 px-2">Apr 10, 2026</td><td className="py-2 px-2">Imitation Learning & Offline RL</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture6.pdf" filename="lecture6.pdf" password="rl">Slides</ProtectedDownload> / <ProtectedDownload href="/lectures/lecture6_annotated.pdf" filename="lecture6_annotated.pdf" password="rl">Annotated</ProtectedDownload></td></tr>
                      <tr className="border-b border-border/50"><td className="py-2 px-2">9</td><td className="py-2 px-2">Apr 17, 2026</td><td className="py-2 px-2">Preference Learning</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/lecture7.pdf" filename="lecture7.pdf" password="rl">Slides</ProtectedDownload> / <ProtectedDownload href="/lectures/lecture7_annotated.pdf" filename="lecture7_annotated.pdf" password="rl">Annotated</ProtectedDownload> / <ProtectedDownload href="/lectures/lecture7_demo.ipynb" filename="lecture7_demo.ipynb" password="rl">Demo</ProtectedDownload></td></tr>
                      <tr className="border-b border-border/50 bg-muted/30"><td className="py-2 px-2">10</td><td className="py-2 px-2">Apr 24, 2026</td><td className="py-2 px-2 italic">No class</td><td className="py-2 px-2"></td></tr>
                      ...
                      <tr><td className="py-2 px-2">15</td><td className="py-2 px-2">May 29, 2026</td><td className="py-2 px-2">Exam Preparation</td><td className="py-2 px-2"><ProtectedDownload href="/lectures/Modern_RL_Mock_Exam.pdf" filename="Modern_RL_Mock_Exam.pdf" password="rl">Mock Exam</ProtectedDownload> / <ProtectedDownload href="/lectures/Modern_RL_Mock_Exam_solutions.pdf" filename="Modern_RL_Mock_Exam_solutions.pdf" password="rl">Solution</ProtectedDownload></td></tr>
                    </tbody>
                  </table>
                </div>
              </CardContent>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full font-body text-sm">
                    ...
                    <tbody className="text-muted-foreground">
                      ...
                      <tr className="border-b border-border/50 bg-muted/30"><td className="py-2 px-2">7</td><td className="py-2 px-2">Apr 3, 2026</td><td className="py-2 px-2 italic">No class</td><td className="py-2 px-2"></td></tr>
                      <tr className="border-b border-border/50"><td className="py-2 px-2">8</td><td className="py-2 px-2">Apr 10, 2026</td><td className="py-2 px-2">GAE, TRPO & PPO</td><td className="py-2 px-2"><ProtectedDownload href="/exercises/Exercise5.ipynb" filename="Exercise5.ipynb" password="rl">Exercise 5</ProtectedDownload> / <ProtectedDownload href="/exercises/Exercise5_SOLUTION.ipynb" filename="Exercise5_SOLUTION.ipynb" password="rl">Solution</ProtectedDownload></td></tr>
                      <tr className="border-b border-border/50"><td className="py-2 px-2">9</td><td className="py-2 px-2">Apr 17, 2026</td><td className="py-2 px-2">BC & DAgger</td><td className="py-2 px-2"><ProtectedDownload href="/exercises/Exercise6.ipynb" filename="Exercise6.ipynb" password="rl">Exercise 6</ProtectedDownload> / <ProtectedDownload href="/exercises/Exercise6_SOLUTION.ipynb" filename="Exercise6_SOLUTION.ipynb" password="rl">Solution</ProtectedDownload></td></tr>
                      <tr className="border-b border-border/50 bg-muted/30"><td className="py-2 px-2">10</td><td className="py-2 px-2">Apr 24, 2026</td><td className="py-2 px-2 italic">No class</td><td className="py-2 px-2"></td></tr>
                      <tr className="border-b border-border/50 bg-muted/30"><td className="py-2 px-2">11</td><td className="py-2 px-2">May 1, 2026</td><td className="py-2 px-2 italic">No class</td><td className="py-2 px-2"></td></tr>
                      <tr className="border-b border-border/50"><td className="py-2 px-2">12</td><td className="py-2 px-2">May 8, 2026</td><td className="py-2 px-2">Preference Learning & Reward Modelling</td><td className="py-2 px-2"><ProtectedDownload href="/exercises/Exercise7.ipynb" filename="Exercise7.ipynb" password="rl">Exercise 7</ProtectedDownload> / <ProtectedDownload href="/exercises/Exercise7_SOLUTION.ipynb" filename="Exercise7_SOLUTION.ipynb" password="rl">Solution</ProtectedDownload></td></tr>
                      <tr className="border-b border-border/50 bg-muted/30"><td className="py-2 px-2">13</td><td className="py-2 px-2">May 15, 2026</td><td className="py-2 px-2 italic">No class</td><td className="py-2 px-2"></td></tr>
                      <tr className="border-b border-border/50"><td className="py-2 px-2">14</td><td className="py-2 px-2">May 22, 2026</td><td className="py-2 px-2">RLHF Optimization: PPO-KL & DPO</td><td className="py-2 px-2"><ProtectedDownload href="/exercises/Exercise8_Part1.ipynb" filename="Exercise8_Part1.ipynb" password="rl">Exercise 8</ProtectedDownload> / <ProtectedDownload href="/exercises/Exercise8_SOLUTION.ipynb" filename="Exercise8_SOLUTION.ipynb" password="rl">Solution</ProtectedDownload></td></tr>
                      <tr><td className="py-2 px-2">15</td><td className="py-2 px-2">May 29, 2026</td><td className="py-2 px-2">GRPO for Verifiable Reasoning</td><td className="py-2 px-2"><ProtectedDownload href="/exercises/Exercise9.ipynb" filename="Exercise9.ipynb" password="rl">Exercise 9</ProtectedDownload> / <ProtectedDownload href="/exercises/Exercise9_SOLUTION.ipynb" filename="Exercise9_SOLUTION.ipynb" password="rl">Solution</ProtectedDownload></td></tr>
                    </tbody>
                  </table>
                </div>
              </CardContent>
